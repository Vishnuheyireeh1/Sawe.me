...
const Industrialprotection = () => {
  ...
  <div className="absolute inset-0 z-10 flex flex-col place-items-start justify-center mx-28">
    ...
    <h1 className="text-black text-6xl font-bold mt-8 mx-6">
      Industrial Protection<span className="text-customRed">System</span>
    </h1>
  ...
  {/* Image with Gradient */}
  <div className="relative">
    <img className="w-[2400px] h-[700px] object-cover" src={aimage1} alt="" />
        ...
        <div className="flex justify-center gap-6 mt-20 ml-10 mr-10">
          <div className="w-[450px] h-[330px] bg-gray-100 relative">
            ...
            <div className="place-items-center p-12">
              ...
              <p className="mt-4">
                Dock Bumpers are vital for cushioning and protecting loading
                docks from frequent impacts during loading and unloading
                operations. By absorbing shocks, these bumpers reduce wear and
                tear, prolonging the lifespan of your docks and enhancing
          ...
          <div className="w-[450px] h-[330px] bg-gray-100 relative">
            <div className="place-items-center p-12">
              ...
              <p className="mt-4">
                Busy industrial environments demand durable solutions for
                high-traffic areas. Our Door Protectors shield industrial doors
                from accidental collisions and impacts, ensuring their longevity
